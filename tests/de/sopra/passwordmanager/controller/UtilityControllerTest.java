...
public class UtilityControllerTest {
    ...
    public void exportImportFileTest() {
        ...
        passwordManagerController.getPasswordManager().setMasterPassword(masterPassword);
        passwordManagerController.getPasswordManager().setMasterPasswordReminderDays(5);
        passwordManagerController.getPasswordManager().setMasterPassordLastChanged(LocalDateTime.now());
